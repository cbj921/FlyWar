(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/enemyPrefab/UFO.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1cdfdjaDo1OKY9fMOHTSGLu', 'UFO', __filename);
// Script/enemyPrefab/UFO.js
...
cc.Class({
    ...
    moveAction: function moveAction() {
        ...
        var moveRight = cc.moveBy(this.moveHorizontalDuration, cc.v2(this.moveHorizontalDistance, 0)).easing(cc.easeCubicActionOut());
        var moveLeft = cc.moveBy(this.moveHorizontalDuration, cc.v2(-this.moveHorizontalDistance, 0)).easing(cc.easeCubicActionOut());
    ...
    updateHealthBar: function updateHealthBar() {
        var ratio = this.varHealth / this.UFOObject.health;
    ...
    bulletAction: function bulletAction(bulletNode) {
        ...
        var duration = (this.node.y + 1100) / (this.UFOObject.bulletSpeed * 100); // 计算时间，这样不管在哪个位置发射子弹速度都一样了
