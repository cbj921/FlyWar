(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/enemyPrefab/waveRobot.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6de9aB7AhtBfZdyvm4psTpB', 'waveRobot', __filename);
// Script/enemyPrefab/waveRobot.js
...
cc.Class({
    ...
    moveAction: function moveAction() {
        ...
        var moveRight = cc.moveBy(this.moveHorizontalDuration, cc.v2(this.moveHorizontalDistance, 0)).easing(cc.easeSineInOut());
        var moveLeft = cc.moveBy(this.moveHorizontalDuration, cc.v2(-this.moveHorizontalDistance, 0)).easing(cc.easeSineInOut());

        var moveHorizontal = cc.repeat(cc.sequence(moveRight, moveLeft), 5); // 左右横移
    ...
    updateHealthBar: function updateHealthBar() {
        var ratio = this.varHealth / this.waveRobotObject.health;
    ...
    getCoin: function getCoin() {
        // 击杀后得到金币
        this.coinData = this.coinData - 0 + this.waveRobotObject.coin;
    ...
    bulletAction: function bulletAction(bulletNode) {
        ...
        var duration = (this.node.y + 1100) / (this.waveRobotObject.bulletSpeed * 100); // 计算时间，这样不管在哪个位置发射子弹速度都一样了
...
cc._RF.pop();
        ...
        //# sourceMappingURL=waveRobot.js.map
